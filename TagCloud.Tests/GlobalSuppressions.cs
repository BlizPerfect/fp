...
[assembly: SuppressMessage("Interoperability", "CA1416:Проверка совместимости платформы", Justification = "<Ожидание>", Scope = "member", Target = "~M:TagCloud.Tests.CloudLayouterTests.CircularCloudLayouterTests.CircularCloudLayouterMainRequirementsTest.Cleanup")]
[assembly: SuppressMessage("Interoperability", "CA1416:Проверка совместимости платформы", Justification = "<Ожидание>", Scope = "member", Target = "~M:TagCloud.Tests.CloudLayouterPaintersTest.CloudLayouterPainterTest.Draw_ThrowsArgumentException_WithEmptyTags")]
